...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('consult_call_details', function (Blueprint $table) {
            ...
            $table->integer('action')->nullable(); //1 - refer outlet/internal clinic, 2 - refer external clinic/specialist, 3 - end process
            ...
            $table->unsignedBigInteger('consulted_by')->nullable(); //staff_id
